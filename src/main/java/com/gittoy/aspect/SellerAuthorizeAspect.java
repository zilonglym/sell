 ...
 * Create By GaoYu 2017/11/27 11:11
 */
@Aspect
@Component
@Slf4j
public class SellerAuthorizeAspect {
    ...
    @Pointcut("execution(public * com.gittoy.controller.Seller*.*(..))" +
    "&& !execution(public * com.gittoy.controller.SellerUserController.*(..))")
    public void verify() {}
